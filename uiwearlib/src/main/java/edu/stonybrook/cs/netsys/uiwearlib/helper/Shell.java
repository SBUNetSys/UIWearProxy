 ...
 * <code>if(ShellInterface.isSuAvailable()) { String date = ShellInterface.getProcessOutput("date");
 * }</code>
 * <p/><p/>
...
public class Shell {
    ...
    public static String getProcessOutput(String command) {
        try {
            return runCommand(command, OUTPUT.STDERR);
    ...
    public static boolean runCommand(String command) {
        try {
            runCommand(command, OUTPUT.BOTH);
            return true;
        } catch (IOException ignored) {
            return false;
        }
    ...
    private static String runCommand(String command, OUTPUT o) throws IOException {
