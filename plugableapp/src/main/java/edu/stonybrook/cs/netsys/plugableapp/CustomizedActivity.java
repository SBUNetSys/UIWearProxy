...
public class CustomizedActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayoutId = R.layout.customized_view;
        UIWearFragment fragment = UIWearFragment.create(mLayoutId);
    ...
    public void testSwitchFragment(View view) {
        if (!hasSwitched) {
            mLayoutId = R.layout.customized_view_2;
            hasSwitched = true;
        } else {
            mLayoutId = R.layout.customized_view;
            hasSwitched = false;
        ...
        fragTransaction.replace(R.id.frame_layout_container, UIWearFragment.create(mLayoutId));
